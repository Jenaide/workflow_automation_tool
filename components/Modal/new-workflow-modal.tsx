...
import { WorkflowTriggers } from "../workflows/workflow-triggers";
import { WorkflowSettings } from "../workflows/workflow-settings";
...
export default function NewWorkflowModal() {
    ...
    return (
        <Dialog>
            <DialogTrigger>
                <Button variant={"default"}>New Workflow</Button>
            </DialogTrigger>
